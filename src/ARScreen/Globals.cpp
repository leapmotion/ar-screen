...
double Globals::globalHeightOffset = -200;
double Globals::globalZOffset = -300;
Eigen::Vector3d Globals::userPos(0, 150 + Globals::globalHeightOffset, 300 + Globals::globalZOffset);
